...
public:
    CMainParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("reborncoin.co", "mainnet1.reborncoin.co"));
        vSeeds.push_back(CDNSSeedData("reborncoin.co", "mainnet2.reborncoin.co"));
        vSeeds.push_back(CDNSSeedData("reborncoin.co", "mainnet3.reborncoin.co"));
        ...
        checkpointData = (Checkpoints::CCheckpointData) {
            ...
            2213527578,     // * UNIX timestamp of last checkpoint block
