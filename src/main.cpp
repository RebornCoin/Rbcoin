...
#if defined(NDEBUG)
# error "Rbcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Rbcoin Signed Message:\n";
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // In Rbcoin this has been enforced since launch, except that the genesis
    // block didn't include the height in the coinbase (see Rbcoin protocol spec
