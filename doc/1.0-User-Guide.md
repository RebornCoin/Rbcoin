...
Translations available [here](https://github.com/rbcoin/rbcoin-docs).
...
https://github.com/rbcoin/rbcoin/doc/payment-api.md
...
```bash
$ git clone https://github.com/rbcoin/rbcoin.git
$ cd rbcoin/
$ git checkout v1.0.13
$ ./rbccutil/fetch-params.sh
```
...
```bash
$ ./rbccutil/build.sh --disable-rust -j$(nproc)
```
...
For a full list of new commands that are not part of bitcoin API (mostly addressing operations on z-addrs) see https://github.com/rbcoin/rbcoin/blob/master/doc/payment-api.md
